    ...
    loading: () => (
      <div className="transition flex flex-col items-center justify-center my-32 gap-4 h-full w-full ">
        ...
        <h1 className="text-3xl text-zinc-100 font-medium">
          Your testimonials are being loaded!
        </h1>
...
export default function ProductPage({
  ...
  useEffect(() => {
    // Simulate loading state change, or adjust based on actual data fetching
    setLoading(false);
  }, [space, testimonials]);
  ...
  const getFilteredTestimonials = () => {
    ...
    switch (tab) {
      ...
      case "liked":
        return testimonials.filter((testimonial) => testimonial.is_liked);
      default:
        return testimonials; // 'all' tab shows all testimonials
    }
  };
