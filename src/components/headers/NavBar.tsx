        ...
        {IsSideBar && (
          <div className="absolute shadow-md inset-x-0 top-full bg-gray-800 m z-10 py-6 pr-4 pl-8 space-y-8">
            ...
            <div className="flex items-center gap-8">
              <Link
                href="/login"
                className="ring-1 ring-purple-600 rounded-sm shadow-md h-full font-medium text-base font-sans text-zinc-100 hover:bg-purple-700 hover:blur-[0.1px] py-2 px-4"
              >
                Sign in
              </Link>
              <Link
