...
export default function Page() {
  ...
  const handleRegister = async () => {
    ...
    try {
      const response = await fetch("https://testimonial-server-kiqu.onrender.com/api/auth/register", {
        method: "POST",
        headers: {
      ...
      {isLoading ? (
        ...
        >
          ...
          <div className="w-full flex gap-4 flex-1">
            <Link
              href="https://testimonial-server-kiqu.onrender.com/api/auth/google"
            ...
            <Link
              href="https://testimonial-server-kiqu.onrender.com/api/auth/github"
