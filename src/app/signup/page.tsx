      ...
      <div className="max-w-xl space-y-8 mx-auto">
        ...
        <form className="bg-gray-800 rounded shadow-md px-11 py-8 space-y-6 max-w-md mx-auto">
          ...
          <div className="w-full flex flex-col gap-1.5">
            ...
            <input required type="text" id="first_name" className="rounded-sm shadow-md border border-zinc-300 text-gray-800 px-4 py-2 placeholder:text-zinc-500 outline-none" placeholder="Enter your first name:" />
          </div>
          ...
          <p className="text-sm text-zinc-400 mx-auto text-center">
            Already have an Account? <Link href='/login' className="font-medium text-purple-600">Sign in</Link>
          </p>
