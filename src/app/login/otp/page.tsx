...
export default function Page() {
  ...
  return (
    <form className="space-y-6 transition duration-500 ease-in-out" onSubmit={handleOTP}>
      ...
      <button className="text-base text-zinc-300 tracking-wide"><span className="text-purple-600">Resent OTP?</span> check your mail!
      </button>
    </form>
  );
}
